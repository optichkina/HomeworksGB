...
def sieve_eratosthenes(i):
    '''Функция поиска i-го простого числа с использованием алгоритма «Решето Эратосфена»'''
...
def prime_counting_function(i):       #Функция возвращает верхнюю границу отрезка на котором лежат
